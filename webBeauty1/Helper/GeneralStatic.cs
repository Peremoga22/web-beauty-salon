...
namespace webBeauty1.Helper
{
    public  class GeneralStatic
    {
       //Our Services 
        ...
        {
            string peelingDescriptionText = "Пілінг допомагає вирішити різноманітні проблеми шкіри, такі як акне, пост акне, зморшки, нерівний тон, пігментація, розширені пори і навіть рубці. Він також сприяє покращенню загального стану шкіри та її текстури.";
